...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_can_start_a_list_and_return_later(self):
		...
		#When you hit enter you are taken to a new URL and now the page lists 
		...
		#Francis starts a new list by entering a new items
		inputbox = self.browser.find_element_by_id('id_new_item')
		...
		#And the new URL shows no sign of ediths list
		page_text = self.browser.find_element_by_tag_name('body').text
		self.assertNotIn('Buy peacock feathers', page_text)
